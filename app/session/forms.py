...
class SessionForm(FlaskForm):
    ...
    campaign = HiddenField("Campaign", validators=[InputRequired(), IsDMForCampaign()])
...
class CampaignSelectForm(FlaskForm):
    campaigns = SelectField("Campaign", validators=[InputRequired(), IsDMForCampaign()], coerce=int)
